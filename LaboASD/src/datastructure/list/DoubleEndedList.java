 ...
 * *************************************************** */
	...
	public void insert(D data) {
		...
		if (head == null) {
			head = tail = tmp;
				...
				tmp.next = head;
				head = tmp;	// Sto impostando il nodo head della mia DoubleEndedList al nodo tmp inserito
			}
	...
	public void append(D data) {
		...
		if(head == null) {
			head = tail = tmp;
				...
				tail.next = tmp;
				tail = tmp; // Sto impostando il nodo tail della mia DoubleEndedList al nodo tmp inserito
			}
	...
	public boolean delete(D data) {
		...
		while(curr != null && !(data.equals(curr.data))) {
			prev = curr;
			curr = curr.next;
		}
